...
This repository attempts to create an analysis report based on client brief 6 
which is an evidence-based, decision-ready understanding of long-run and seasonal 
temperature change in Central England using the Met Office HadCET seasonal mean, 
minimum and maximum temperature series (v2.1.0.0). 


## What this repo produces [STC]

[WIP] A client-facing report that follows the required structure:
